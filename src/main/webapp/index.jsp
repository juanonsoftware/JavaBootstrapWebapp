		...
		<div class="container py-4">
			<header class="pb-3 mb-4 border-bottom">
				<a href="/"
					...
					<span class="fs-4">Welcome to MyWebApp</span>
				</a>
			</header>

			<div class="p-5 mb-4 bg-body-tertiary rounded-3">
				<div class="container-fluid py-5">
					<h1 class="display-5 fw-bold">Just a site template</h1>
					<p class="col-md-8 fs-4">A Maven project with just a single page. This can be used as a starting point for your web app.</p>
